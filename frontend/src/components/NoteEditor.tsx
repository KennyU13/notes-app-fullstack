...
export function NoteEditor({ note, onEnregistrer }: { note?: Note | null; onEnregistrer: (payload: { titre: string; contenu: string; couleur: string; tags: string[] }) => Promise<void> }) {
  ...
  return (
    <form onSubmit={(e) => { e.preventDefault(); void onEnregistrer({ titre, contenu, couleur, tags }); }} className="rounded-3xl bg-glass p-5 shadow-glass">
